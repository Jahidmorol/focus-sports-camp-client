    ...
    <div className="w-[90%] mx-auto bg-inherit p-6 my-5 ">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="md:flex gap-4">
          ...
          <div className="mb-4 md:w-1/2">
            <label className="block font-bold mb-1">Instructor Email</label>
            <input
              type="email"
        ...
        <div className="md:flex gap-4">
          <div className="mb-4 md:w-1/2">
            <label className="block font-bold mb-1">Class Name</label>
            <input
          ...
          <div className="mb-4 md:w-1/2">
            <label className="block font-bold mb-1">Class Image</label>
            <input
              type="file"
        ...
        <div className="md:flex gap-4">
          <div className="mb-4 md:w-1/2">
            <label className="block font-bold mb-1">Available Seats</label>
            <input
